...
def main():
    ...
    get_batch_size(32, 64, epochs, steps_per_epoch, filename)
    get_batch_size(16, 96, epochs, steps_per_epoch, filename)
    get_batch_size(16, 128, epochs, steps_per_epoch, filename)
