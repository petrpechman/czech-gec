from introduce_errors import introduce_token_level_errors_on_sentence, introduce_token_level_errors_on_sentence_timer, get_char_vocabulary, get_token_vocabulary, introduce_char_level_errors_on_sentence, introduce_token_level_errors_on_sentence_old
import aspell
import numpy as np
...
np.random.seed(seed)
result1 = introduce_token_level_errors_on_sentence_old("Moje krásná věta .".split(' '), token_replace_prob, token_insert_prob, token_delete_prob,
                                                        token_swap_prob, recase_prob, token_err_prob, token_std_dev,
                                                        tokens, aspell_speller)
time1 = timeit(lambda: introduce_token_level_errors_on_sentence_old("Moje krásná věta .".split(' '), token_replace_prob, token_insert_prob, token_delete_prob,
                                                        token_swap_prob, recase_prob, token_err_prob, token_std_dev,
